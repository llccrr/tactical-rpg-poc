export const CLASSES = [
    {
        id: "bretteur",
        name: "Bretteur",
        description: "Guerrier au corps-a-corps, devastateur en melee. Ses lames tranchent sans pitie ceux qui osent l'approcher.",
        baseHp: 35,
        baseAttack: 6,
        baseDefense: 3,
        basePm: 3,
    ...
    },
    {
        id: "sentinelle",
        name: "Sentinelle",
        description: "Tireur d'elite a longue portee, precis et mobile. Garde ses distances pour mieux frapper.",
        baseHp: 22,
        baseAttack: 4,
        baseDefense: 1,
        basePm: 4,
