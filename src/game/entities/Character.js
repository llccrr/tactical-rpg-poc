...
export class Character extends Phaser.GameObjects.Graphics {
    constructor(scene, gridPos, colors = PLAYER_COLORS) {
        super(scene);
        ...
        this.setInteractive(new Phaser.Geom.Rectangle(-hitW / 2, -CUBE_ELEVATION - CUBE_H / 2, hitW, hitH), Phaser.Geom.Rectangle.Contains);
    ...
    async moveAlongPath(scene, path) {
        this.isMoving = true;
